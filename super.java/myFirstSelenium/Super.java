...
public class Super {
	...
	public static void main(String[] args)throws InterruptedException {
      ...
      driver.get("https://superpharm-prod.mirakl.net/login");
      Thread.sleep(10000);
      driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div[3]/form/div[1]/div/div/input")).sendKeys(" adi@tudo.co.il");
      Thread.sleep(5000);
      driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div[3]/form/div[3]/div[1]/button")).click();
      Thread.sleep(5000);
